        ...
        <section className="dark:bg-gray-800  bg-white min-h-svh ">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-sm text-center relative">
                    ...
                    <p className="mb-4 text-3xl tracking-tight font-bold text-gray-900 md:text-4xl  dark:text-white hover:text-blue-800 dark:hover:text-blue-300">Something&apos;s missing.</p>
                    <p className="mb-10 text-lg font-light text-gray-700 dark:text-gray-400">Sorry, we can&apos;t find that page. You&apos;ll find lots to explore on the home page. </p>
